!(function(t) {
  ...
  "function" == typeof require && "object" == typeof exports
    ? (module.exports = t())
    : "function" == typeof define && define.amd ? define(["velocity"], t) : t();
})(function() {
  "use strict";
  return (function(t, a, e, r) {
    ...
    (i.RegisterEffect = i.RegisterUI = function(t, a) {
      function e(t, a, e, r) {
        ...
        s.each(t.nodeType ? [t] : t, function(t, a) {
          ...
          "border-box" ===
            i.CSS.getPropertyValue(a, "boxSizing")
              .toString()
      ...
      return (
        (i.Redirects[t] = function(n, o, l, c, u, f, p) {
          var d = l === c - 1,
            g = 0;
          (p = p || a.loop),
            "function" == typeof a.defaultDuration
              ? (a.defaultDuration = a.defaultDuration.call(u, u))
              : (a.defaultDuration = parseFloat(a.defaultDuration));
          for (var y = 0; y < a.calls.length; y++)
            (v = a.calls[y][1]), "number" == typeof v && (g += v);
          var m = g >= 1 ? 0 : a.calls.length ? (1 - g) / a.calls.length : 1;
          for (y = 0; y < a.calls.length; y++) {
            var X = a.calls[y],
              Y = X[0],
              O = 1e3,
              v = X[1],
            ...
            if (
              (o.duration !== r
                ? (O = o.duration)
                : a.defaultDuration !== r && (O = a.defaultDuration),
              (h.duration = O * ("number" == typeof v ? v : m)),
              (h.queue = o.queue || ""),
              (h.easing = D.easing || "ease"),
              (h.delay = parseFloat(D.delay) || 0),
              (h.loop = !a.loop && D.loop),
              (h._cacheValues = D._cacheValues || !0),
              0 === y)
            ) {
              if (
                ((h.delay += parseFloat(o.delay) || 0),
                0 === l &&
                  (h.begin = function() {
                    ...
                    a &&
                      "In" === a[0] &&
                      Y.opacity !== r &&
                      s.each(u.nodeType ? [u] : u, function(t, a) {
                        i.CSS.setPropertyValue(a, "opacity", 0);
                      }),
                      o.animateParentHeight &&
                        a &&
                        e(u, a[0], O + h.delay, o.stagger);
                  }),
                null !== o.display)
              )
                if (o.display !== r && "none" !== o.display)
                  ...
                  var I = i.CSS.Values.getDisplayType(n);
                  h.display = "inline" === I ? "inline-block" : I;
                }
              o.visibility &&
                "hidden" !== o.visibility &&
                (h.visibility = o.visibility);
            }
            if (y === a.calls.length - 1) {
              var P = function() {
                (o.display !== r && "none" !== o.display) ||
                  ...
                  o.complete && o.complete.call(u, u),
                  f && f.resolver(u || n);
              };
              (h.complete = function() {
                if (
                  (p &&
                    i.Redirects[t](
                      ...
                      u,
                      f,
                      p === !0 ? !0 : Math.max(0, p - 1)
                    ),
                  a.reset)
                ) {
                  for (var e in a.reset)
                    if (a.reset.hasOwnProperty(e)) {
                      var s = a.reset[e];
                      i.CSS.Hooks.registered[e] !== r ||
                        ("string" != typeof s && "number" != typeof s) ||
                        (a.reset[e] = [a.reset[e], a.reset[e]]);
                    }
                  var g = { duration: 0, queue: !1 };
                  d && (g.complete = P), i.animate(n, a.reset, g);
                } else d && P();
              }),
                "hidden" === o.visibility && (h.visibility = o.visibility);
            }
            i.animate(n, Y, h);
          }
        }),
    ...
    for (var u in i.RegisterEffect.packagedEffects)
      i.RegisterEffect.packagedEffects.hasOwnProperty(u) &&
        i.RegisterEffect(u, i.RegisterEffect.packagedEffects[u]);
    i.RunSequence = function(t) {
      var a = s.extend(!0, [], t);
      a.length > 1 &&
        (s.each(a.reverse(), function(t, e) {
          var r = a[t + 1];
          if (r) {
            var n = e.o || e.options,
              o = r.o || r.options,
