...
var sectionObj = {
   'Facials': ['Plainum', 'Gold', 'Eschborn', 'Diamond', 'Pearl', 'Fruit', 'Kesar', 'Choco', 'Anti Acne Pimple', 'Whitening', 'Whitening glow', 'Oxy glow', 'Natural'],
   'Hair Cuts': ['Kids cut', 'Straight Cut', 'Normal U', 'Deep U', 'Step Cut', 'Laser Cut', 'Feather cut', 'Mushroom cut', 'Bluts cut', 'Layer cut'],
   'Hair Treatments': ['Straitening', 'Soothening', 'Coloring', 'Henna', 'Shampoo', 'Rebounding', 'Volumizing', 'Hair Spa', 'Drandru  Treatment'],
